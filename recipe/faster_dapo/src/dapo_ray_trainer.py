    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    if not self.config.algorithm.filter_groups.enable:
                        ...
                        if num_prompt_in_batch < prompt_bsz:
                            ...
                            next_batch_size = min(int(np.ceil(next_batch_size / gpu_num) * gpu_num), self.config.data.train_batch_size)
                            ...
                            self.current_batch_size = self.config.data.train_batch_size
                ...
                metrics["train/num_sampled_prompts"] = num_sampled_prompts
                batch = None
                num_prompt_in_batch = 0
                num_gen_batches = 0
                num_sampled_prompts = 0

...
def verify(
    ...
    correct1, pred1 = is_correct_strict_box(solution_str, answer, pause_tokens_index)
    correct2, pred2 = is_correct_minerva(solution_str, answer)
    return (correct1 == 1) or correct2, pred1 or pred2
